...
- Exceptions: Fueron referenciadas usando throws, para el seguimiento y es posible implementarlo con más detalle si el proyecto se coloca más complejo. Además se puede complementar con el Logger.
- Entre otras.
...
- Se debe setear el browser con el cual se correrán las pruebas. Para ello editar el archivo "LinkedIn_project\src\stepDefinition\TestSteps.java" y modificar la variable "browserFlag". Los posibles valores son: 1 para Chrome; 2 para IE.
...
F. Drivers
==========
Los drivers para manejar los browser soportados están disponibles en la siguiente ruta, los que incluyen: Chrome e IE.
